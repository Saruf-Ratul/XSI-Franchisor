...
- Create Angular project with ng: `ng new xsi-franchisor.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`xsi-franchisor.client.esproj`).
